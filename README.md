...
[![Build Status](https://travis-ci.org/fabware/grpc-gateway.svg?branch=master)](https://travis-ci.org/fabware/grpc-gateway)
...
```sh
go get -u github.com/fabware/grpc-gateway/protoc-gen-grpc-gateway
go get -u github.com/fabware/grpc-gateway/protoc-gen-swagger
...
3. Generate gRPC stub
   ...
   protoc -I/usr/local/include -I. \
     -I$GOPATH/src \
     -I$GOPATH/src/github.com/fabware/grpc-gateway/third_party/googleapis \
     --go_out=Mgoogle/api/annotations.proto=github.com/fabware/grpc-gateway/third_party/googleapis/google/api,plugins=grpc:. \
...
See [LICENSE.txt](https://github.com/fabware/grpc-gateway/blob/master/LICENSE.txt) for more details.
